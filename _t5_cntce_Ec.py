...
config = "CC_CVS_Ec_Linear_inTok"+str(max_input_length)
...
video_embed_path = path+"/clip_vid_embed/" #CLIP Video Embed
...
def preprocess_function(examples):
    ...
    for (sent, v_id, start_t, v_title, summ) in zip(examples["sentence"], examples["video_id"], examples["start_time"], examples["video_title"], examples["summary"]):
            ...
            try:
                ...
                compressed_vid.append(torch.zeros(2,512)) #CLIP VID EMBED
